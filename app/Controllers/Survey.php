        ...
        $survey = [
            ...
            "questions" => [
                ...
                [
                    ...
                    "family" => "radio",
                    "responses" => [
                        ["token" => "100011", "name" => "Très bon", "position" => 1],
                        ["token" => "100012", "name" => "pas du tout", "position" => 2],
                        ["token" => "100013", "name" => "Con", "position" => 3],
                        ["token" => "100014", "name" => "Nul", "position" => 4]
                    ]
                ],
                [
                    "token" => "100002",
                ...
                [
                    "token" => "100007",
                    "name" => "Veuillez donner une note globale au service",
                    "description" => "Attribuez une étoile de 1 à 5 étoiles",
                    "position" => 7,
                    "required" => true,
                    "family" => "stars",
                    "responses" => null
                ...
                [
                    "token" => "100006",
                    "name" => "Avez-vous des explication ou commentaires à nous faire ?",
                    "description" => "Exprimez librement votre avis",
                    "position" => 6,
                    "required" => false,
                    "family" => "longtext",
